...
router.route('/bookings/:id/unassign-table').patch(adminController_1.unassignTable);
router.route('/bookings/:id/table').put(adminController_1.updateBookingTable);
router.route('/bookings/:id/assign-table').patch(adminController_1.assignTable);
router.route('/bookings/:id/check-in').patch(adminController_1.checkInBooking);
