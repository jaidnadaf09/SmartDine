...
const WaiterPortal = lazy(() => import('./portals/waiter/pages/WaiterPortal'));
const ChefPortal = lazy(() => import('./portals/chef/pages/ChefPortal'));
const AdminPortal = lazy(() => import('./portals/admin/pages/AdminPortal'));
